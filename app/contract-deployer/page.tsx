...
export const metadata = {
  title: "On-Chain Smart Contract Deployer Studio | MIJ Digital Web3 Enterprise",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b-2 border-slate-900">
        <div>
          ...
          <p className="text-xs text-slate-600 mt-1">
            Compile and deploy custom EVM Smart Contracts (ERC-20 Tokens, NFT Collections, Staking Vaults) one by one directly to Ethereum & Polygon.
          </p>
        </div>
      </div>
